...
import { successPaymentEndPoint } from "@src/component/cart/paymentEndpoint";
          ...
          switch (method) {
            case "CASH":
              setMessage({
                ...
                body: "Đơn hàng sẽ được thanh toán khi nhận hàng!",
                color: "text-green-500",
              });
              break;
            case "PAYPAL":
              setMessage({
                title: "Đặt hàng thành công qua PayPal!",
                body: "Đơn hàng đã được thanh toán thành công qua PayPal!",
                color: "text-green-500",
              });
              break;
            default:
